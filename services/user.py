...
class UserService:
    ...
    async def update_user(
        ...
        user = await UserService.check_if_user_exists_by_id(session, user_id)
        assert (
            user is not None
